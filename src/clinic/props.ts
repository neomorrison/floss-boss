...
const BUILDERS: Record<string, () => THREE.Object3D> = {
  ...
  // ---------------------------------------------------------------- v3 op upgrades (DESIGN 10.5)
  ergo_stool: () => group(
    cyl(0.22, 0.22, 0.06, C.mint, 0, 0.42, 0, 20),
    cyl(0.03, 0.03, 0.36, C.steel, 0, 0.06, 0),
    cyl(0.16, 0.18, 0.03, C.steel, 0, 0, 0, 24),
  ),
  nitrous_tank: () => group(
    cyl(0.09, 0.1, 0.4, mat(C.sky, 0.35, 0.5), 0, 0.02, 0, 14),
    sph(0.09, C.steel, 0, 0.42, 0, 1, 0.5, 1),
    cyl(0.11, 0.11, 0.04, C.steel, 0, 0, 0, 14),
  ),

  // ---------------------------------------------------------------- v3 equipment (DESIGN 10.5)
  water_filter: () => group(
    box(0.3, 0.55, 0.3, C.white, 0, 0, 0, 0.04),
    cyl(0.1, 0.1, 0.3, waterMat(), 0, 0.58, 0, 14),
    box(0.06, 0.03, 0.06, C.steel, 0, 0.56, 0.16, 0.01),
  ),
  aroma_diffuser: () => group(
    cyl(0.11, 0.13, 0.16, C.white, 0, 0, 0, 16),
    cyl(0.08, 0.1, 0.05, C.wainscot, 0, 0.16, 0, 16),
    sph(0.05, mat('#DDEFFF', 0.2, 0, '#DDEFFF', 0.55), 0, 0.26, 0, 1, 1.3, 1),
  ),
  loyalty_board: () => group(
    box(0.86, 0.5, 0.03, C.woodDark, 0, 0, 0, 0.02),
    box(0.7, 0.36, 0.01, '#F1DDB0', 0, 0.02, 0.02, 0.01),
    box(0.16, 0.1, 0.01, C.bubblegum, -0.2, 0.08, 0.03, 0.005),
    box(0.16, 0.1, 0.01, C.sky, 0.05, 0.02, 0.03, 0.005),
    box(0.16, 0.1, 0.01, C.sunshine, -0.05, -0.1, 0.03, 0.005),
  ),
  staff_lockers: () => group(
    box(0.3, 1.5, 0.4, C.mint, -0.33, 0, 0, 0.02), box(0.3, 1.5, 0.4, C.teal, 0, 0, 0, 0.02), box(0.3, 1.5, 0.4, C.mint, 0.33, 0, 0, 0.02),
    box(0.03, 1.4, 0.02, C.steel, -0.23, 0, 0.21, 0.005), box(0.03, 1.4, 0.02, C.steel, 0.1, 0, 0.21, 0.005), box(0.03, 1.4, 0.02, C.steel, 0.43, 0, 0.21, 0.005),
  ),
  digital_xray: () => group(
    box(0.42, 0.32, 0.04, C.dark, 0, 0, 0, 0.02),
    plane(0.36, 0.26, screenMat(), 0, 0, 0.021),
  ),
  sound_panel: () => group(
    box(0.76, 0.4, 0.04, mat(C.wainscot, 0.9), 0, 0, 0, 0.02),
    box(0.68, 0.32, 0.01, mat('#B9E3D8', 0.95), 0, 0, 0.021, 0.02),
  ),
  patient_tablet: () => group(
    box(0.22, 0.16, 0.015, C.dark, 0, 0, 0, 0.015),
    plane(0.18, 0.12, screenMat(), 0, 0, 0.009),
    rotX(cyl(0.02, 0.02, 0.12, C.steel, 0, -0.14, 0.03), -0.3),
  ),
  laser_whitening: () => group(
    box(0.5, 0.62, 0.4, C.white, 0, 0, 0, 0.04),
    box(0.2, 0.06, 0.2, mat('#DDEFFF', 0.2, 0, '#8FD3FF', 0.5), 0, 0.62, 0, 0.02),
    rotX(cyl(0.03, 0.03, 0.3, C.steel, 0.18, 0.62, 0.1), 0.3),
  ),
  spa_lounge: () => group(
    box(0.9, 0.1, 0.6, C.sunshine, 0, 0.34, 0, 0.06),
    rotX(box(0.9, 0.1, 0.5, C.sunshine, 0, 0.48, -0.35, 0.06), -0.5),
    cyl(0.18, 0.16, 0.32, C.pot, -0.6, 0, 0.3),
    ball(0.22, C.leaf, -0.6, 0.5, 0.3, 1),
    cyl(0.22, 0.22, 0.02, waterMat(), 0.55, 0.02, 0.25, 16),
  ),
  cadcam_mill: () => group(
    box(0.7, 0.5, 0.5, C.steel, 0, 0, 0, 0.04),
    box(0.5, 0.3, 0.1, C.dark, 0, 0.52, -0.18, 0.02),
    plane(0.42, 0.22, screenMat(), 0, 0.52, -0.129),
    cyl(0.05, 0.05, 0.12, C.sunshine, 0.2, 0.5, 0.15),
  ),
  rooftop_planter: () => group(
    box(0.9, 0.22, 0.24, C.pot, 0, 0, 0, 0.03),
    ball(0.16, C.leaf, -0.28, 0.24, 0, 1), ball(0.14, C.leafDark, 0, 0.28, 0, 1), ball(0.15, C.leaf, 0.28, 0.24, 0, 1),
  ),
  smile_studio: () => group(
    box(0.7, 0.9, 0.06, C.white, 0, 0.3, 0, 0.06),
    box(0.6, 0.8, 0.01, mat('#DDEFFF', 0.1, 0.2, '#DDEFFF', 0.15), 0, 0.3, 0.035, 0.03),
    ball(0.03, mat(C.sunshine, 0.3, 0, C.sunshine, 0.9), -0.32, 0.66, 0.04, 0),
    ball(0.03, mat(C.sunshine, 0.3, 0, C.sunshine, 0.9), 0.32, 0.66, 0.04, 0),
    ball(0.03, mat(C.sunshine, 0.3, 0, C.sunshine, 0.9), -0.32, 0.02, 0.04, 0),
    ball(0.03, mat(C.sunshine, 0.3, 0, C.sunshine, 0.9), 0.32, 0.02, 0.04, 0),
  ),
  research_desk: () => group(
    box(1.1, 0.7, 0.6, C.woodDark, 0, 0, 0, 0.02),
    box(0.3, 0.28, 0.18, C.white, 0.25, 0.7, 0, 0.03),
    cyl(0.02, 0.02, 0.14, C.steel, 0.25, 0.84, 0),
    cyl(0.06, 0.08, 0.05, C.dark, 0.25, 0.9, 0),
    plane(0.32, 0.2, screenMat(), -0.2, 0.85, -0.28),
  ),
  helipad_sign: () => group(
    cyl(0.03, 0.03, 1.0, C.steel, 0, 0, 0),
    cyl(0.32, 0.32, 0.04, mat(C.ink, 0.6), 0, 1.0, 0, 24),
    box(0.06, 0.26, 0.01, C.white, -0.09, 1.14, 0.022),
    box(0.06, 0.26, 0.01, C.white, 0.09, 1.14, 0.022),
    box(0.15, 0.06, 0.01, C.white, 0, 1.14, 0.022),
  ),
  ai_screen: () => group(
    box(0.28, 0.2, 0.02, C.dark, 0, 0, 0, 0.015),
    plane(0.22, 0.14, mat('#B9F2E2', 0.3, 0, '#3DD6B5', 0.7), 0, 0, 0.011),
  ),

  // ---------------------------------------------------------------- event and campaign props (DESIGN 10.2)
  prop_puppy: () => group(
    box(0.22, 0.12, 0.34, '#E8B978', 0, 0.14, 0, 0.06),
    ball(0.11, '#E8B978', 0, 0.24, 0.2, 1),
    ball(0.03, C.ink, -0.04, 0.27, 0.29, 0), ball(0.03, C.ink, 0.04, 0.27, 0.29, 0),
    ball(0.025, C.ink, 0, 0.22, 0.31, 0),
    box(0.06, 0.1, 0.03, '#C99A5B', -0.09, 0.26, 0.16, 0.02), box(0.06, 0.1, 0.03, '#C99A5B', 0.09, 0.26, 0.16, 0.02),
    box(0.04, 0.13, 0.04, '#E8B978', -0.08, 0.02, 0.12, 0.02), box(0.04, 0.13, 0.04, '#E8B978', 0.08, 0.02, 0.12, 0.02),
    box(0.04, 0.13, 0.04, '#E8B978', -0.08, 0.02, -0.12, 0.02), box(0.04, 0.13, 0.04, '#E8B978', 0.08, 0.02, -0.12, 0.02),
    ball(0.04, '#E8B978', 0, 0.15, -0.19, 1),
  ),
  prop_balloons: () => group(
    cyl(0.015, 0.015, 1.0, C.steel, 0, 0.5, 0),
    ball(0.14, C.bubblegum, -0.08, 1.1, 0, 1), ball(0.13, C.sunshine, 0.08, 1.16, 0.03, 1), ball(0.135, C.sky, 0, 1.28, -0.04, 1),
  ),
  prop_jolly_roger: () => group(
    cyl(0.025, 0.025, 1.6, C.woodDark, 0, 0.8, 0),
    box(0.5, 0.34, 0.02, C.ink, 0.27, 1.35, 0, 0.01),
    ball(0.06, C.white, 0.2, 1.4, 0.012, 1),
    box(0.14, 0.03, 0.012, C.white, 0.34, 1.28, 0.012, 0),
  ),
  prop_rival_sign: () => group(
    cyl(0.05, 0.05, 1.6, C.steel, -0.6, 0.8, 0), cyl(0.05, 0.05, 1.6, C.steel, 0.6, 0.8, 0),
    box(1.6, 0.5, 0.1, mat('#F0555B', 0.6), 0, 1.65, 0, 0.05),
    box(1.4, 0.32, 0.01, mat('#FFE3E3', 0.7), 0, 1.65, 0.06, 0.02),
  ),
  prop_camera_crew: () => group(
    rotX(cyl(0.02, 0.02, 0.8, C.dark, -0.15, 0.4, 0), 0),
    rotZ(cyl(0.02, 0.02, 0.8, C.dark, 0.15, 0.4, 0.15), 0.35), rotZ(cyl(0.02, 0.02, 0.8, C.dark, 0.15, 0.4, -0.15), -0.35),
    box(0.24, 0.16, 0.34, C.dark, 0, 0.9, 0, 0.03),
    cyl(0.06, 0.08, 0.14, C.steel, 0, 0.9, 0.22),
    box(0.08, 0.03, 0.01, mat(C.sunshine, 0.3, 0, C.sunshine, 0.8), 0, 0.98, 0.3, 0),
  ),
  prop_generator: () => group(
    box(0.5, 0.4, 0.34, mat('#F0555B', 0.6), 0, 0, 0, 0.04),
    box(0.5, 0.06, 0.34, C.steel, 0, 0.4, 0, 0.02),
    cyl(0.03, 0.03, 0.2, C.steel, -0.18, 0.5, 0),
    cyl(0.05, 0.05, 0.03, C.dark, 0.15, 0.03, 0.18, 14),
  ),
  prop_red_carpet: () => group(
    box(1.0, 0.01, 1.6, '#C93B45', 0, 0, 0, 0.01),
