...
const PATHS: Record<string, string> = {
  ...
  caseGrillz: S('M3 9.5c2.8-2.2 5.8-3.3 9-3.3s6.2 1.1 9 3.3v3.6c-2.8 2.4-5.8 3.6-9 3.6s-6.2-1.2-9-3.6z') + S('M7.6 7.4v8.2M12 6.2v10.5M16.4 7.4v8.2')
    + `<path fill="currentColor" stroke="none" d="M5.3 10.9l1-1.2 1 1.2-1 1.2zM9.8 10.9l1.1-1.3 1.1 1.3-1.1 1.3zM14.2 10.9l1.1-1.3 1.1 1.3-1.1 1.3zM18.7 10.9l1-1.2 1 1.2-1 1.2z"/>`
    + S('M19.5 2.2l.6 1.5 1.5.6-1.5.6-.6 1.5-.6-1.5-1.5-.6 1.5-.6z'),
  diamond: S('M6.5 4h11l4 5.2L12 20.5 2.5 9.2z') + S('M2.5 9.2h19M9 4l-1.8 5.2L12 20.5l4.8-11.3L15 4'),
  trophy: S('M7.5 3.5h9v5.5a4.5 4.5 0 0 1-9 0z') + S('M7.5 5.2H4.8a3 3 0 0 0 3.1 4.3M16.5 5.2h2.7a3 3 0 0 1-3.1 4.3') + S('M12 13.5v3M8.5 20.5h7l-.8-4h-5.4z'),
  city: `<rect x="3" y="10" width="6" height="10.5" rx="1"/><rect x="9" y="4" width="7" height="16.5" rx="1"/><rect x="16" y="8" width="5" height="12.5" rx="1"/>` + S('M11.5 7.5h2M11.5 11h2M11.5 14.5h2M5 13.5h2M5 17h2M17.8 11.5h1.4M17.8 15h1.4') + S('M2 20.5h20'),
  scissors: `<circle cx="6.5" cy="17.5" r="2.8"/><circle cx="17.5" cy="17.5" r="2.8"/>` + S('M8.4 15.4 18 4M15.6 15.4 6 4'),
